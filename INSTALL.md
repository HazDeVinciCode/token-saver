...
- si le projet a une commande d'autonomie (par exemple `/autonomie-totale`) : qu'elle lance désormais les **sessions neuves** à sa place, une par cycle, et que sa commande d'arrêt (par exemple `/stop-autonomie`) les arrête ; si elles ne peuvent pas démarrer, l'autonomie part dans l'app comme avant et un message le dit ;
